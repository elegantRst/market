  ...
  return (
    <>
      <div className={styles.page_showroom__item}>
        ...
        <Slider className="page_showroom__item_mainimage" {...settings1} asNavFor={nav2} ref={(slider1) => setNav1(slider1)}>
        ...
        <Slider className="page_showroom__item_thumbimage" {...settings2} asNavFor={nav1} ref={(slider2) => setNav2(slider2)}>
          {findItem.slides.map((item, index) => (
            <a key={index} onClick={() => imageClick(item, index)}>
              <img src={item} alt="alt" />
            </a>
